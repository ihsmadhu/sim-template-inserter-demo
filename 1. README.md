...
<p align="center">
  <img src="screenshots/template-sidebar-demo.gif" width="75%" alt="Demo Preview"/>
</p>

# Sim Template inserter — Demo Version
Comment Hub is a **browser userscript** that provides a centralized hub for managing and inserting reusable text templates across multiple web portals.
